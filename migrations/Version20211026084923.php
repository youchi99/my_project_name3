 ...
 */
final class Version20211026084923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       $this->addSql('CREATE TABLE extensions (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, host VARCHAR(255) DEFAULT NULL, secret VARCHAR(255) DEFAULT NULL, context VARCHAR(255) DEFAULT NULL, username VARCHAR(255) DEFAULT NULL, fullname VARCHAR(255) DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sipusers_triger (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, defaultuser VARCHAR(255) DEFAULT NULL, host VARCHAR(255) DEFAULT NULL, sippasswd VARCHAR(255) DEFAULT NULL, fromuser VARCHAR(255) DEFAULT NULL, fromdomain VARCHAR(255) DEFAULT NULL, mailbox VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE sipusers_triger');
